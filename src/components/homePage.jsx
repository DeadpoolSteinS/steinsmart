        ...
        <div className="flex justify-between mb-4">
          <div className="flex gap-2">
            <button
              ...
              className="py-2 px-4 bg-[#F9A825] text-white rounded-lg shadow-lg font-semibold"
            >
              Tambah Product
            </button>
            <Link
              to="/history"
              className="py-2 px-4 border-2 border-[#F9A825] text-[#F9A825] rounded-lg shadow-lg font-semibold"
            >
              History
            </Link>
          </div>
          <form
            ...
            className="px-6 flex items-center gap-2 rounded-md shadow-md border-2"
          >
            <input
              type="search"
            ...
            <Link to={`/product/${product._id}`} key={product._id}>
              <div className="relative rounded-xl shadow-lg">
                ...
                <div className="px-6 py-4 h-[116px] rounded-b-lg">
                  <div className="font-bold text-lg mb-2 text-[#F9A825] ">
                    {product.name}
                  </div>
