    ...
    <div>
      ...
      <div className="container mx-auto py-8">
        <div className="flex items-start">
          <img src={product.image} alt={product.name} className="h-80 w-80 object-cover" />
          <div className="w-full h-80 px-4 flex flex-col justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-800 mb-3">{product.name}</h1>
              <hr className="border mb-3" />
              <p className="text-gray-700 text-base leading-relaxed font-bold mb-3"> Rating : {product.rating}</p>
            ...
            <div className="flex flex-col">
              ...
              <p className="flex justify-start mt-5 mb-5 text-3xl font-semibold text-[#F9A825]">{product.price}</p>
        ...
        <div className="mt-8">
          ...
          <form onSubmit={handleSubmitComment} className="mb-8 mt-10">
            <div className="mb-4">
              ...
              <input type="text" id="comment" name="comment" value={comment} onChange={(event) => setComment(event.target.value)} className="border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:shadow-outline" />
            </div>
            <div className="flex justify-end">
              <button type="submit" className="px-4 py-2 bg-[#F9A825] text-white rounded hover:bg-[#d38b18] focus:outline-none focus:shadow-outline">
                Submit
              </button>
            </div>
          </form>
